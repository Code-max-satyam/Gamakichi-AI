...
const Main = () => {
    ...
    const handleCardClick = (prompt) => onSent(prompt);
            ...
            <div className="main-container">
                ...
                {!showResult ? (
                    <>
                        ...
                        <div className="cards">
                            <div onClick={() => handleCardClick("What are some amazing facts about space?")} className="card">
                                <p>What are some amazing facts about space?</p>
                                <img src={assets.message_icon} alt="" />
                            </div>
                            <div onClick={() => handleCardClick("Suggest 5 budget-friendly travel destinations")} className="card">
                                <p>Suggest 5 budget-friendly travel destinations</p>
                                <img src={assets.compass_icon} alt="" />
                            </div>
                            <div onClick={() => handleCardClick("What is artificial intelligence and how does it work?")} className="card">
                                <p>What is artificial intelligence and how does it work?</p>
                                <img src={assets.bulb_icon} alt="" />
                            </div>
                            <div onClick={() => handleCardClick("What are the top in-demand skills in 2025?")} className="card">
